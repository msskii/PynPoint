...
@typechecked
def get_attributes(instrument_key="Default") -> Dict[str, Dict[str, Union[str, float, int, None]]]:
    """
    ...
    if instrument_key == "MIRI":
        ...
        attr = {'PIXSCALE': {'attribute': 'non-static',
                             'config': 'header',
                             'value': 'CDELT1',
                             'type': 'float'},
                ...
                'NFRAMES': {'attribute': 'non-static',
                            ...
                            'value': 'NAXIS3',
                            'type': 'int'},
                'NAXISA': {'attribute': 'non-static',
                           'config': 'header',
                           'value': 'NAXIS1',
                           'type': 'int'},
                'NAXISB': {'attribute': 'non-static',
                           'config': 'header',
                           'value': 'NAXIS2',
                           'type': 'int'},
                ...
                'PARANG': {'attribute': 'non-static',
                           ...
                           'value': 'None',
                           'type': 'float'},
                'WAV_START': {'attribute': 'non-static',
                               'config': 'header',
                               'value': 'WAV_START',
                               'type': 'float'},
                'WAV_INCR': {'attribute': 'non-static',
                               'config': 'header',
                               'value': 'WAV_INCR',
                               'type': 'float'},
